					...
					<div class="col-sm-12">
						<div class="card">
							...
							<div class="card-block">
									...
									<div class="col-sm-6 col-md-4 col-xl-4">
										...
										<div>
											<div class="form-group">
												...
												<div>
													<asp:TextBox ID="textName" runat="server" CssClass="form-control" placeholder="Enter Product Name"></asp:TextBox>
											...
											<div class="form-group">
												...
												<div>
													<asp:TextBox ID="textDescription" runat="server" CssClass="form-control" placeholder="Enter Product Description" TextMode="MultiLine"></asp:TextBox>
											...
											<div class="form-group">
												...
												<div>
													<asp:TextBox ID="textPrice" runat="server" CssClass="form-control" placeholder="Enter Product Price"></asp:TextBox>
													...
													<asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ErrorMessage="Price must be in decimal" ForeColor="Red" Display="Dynamic" SetFocusOnError="true" ControlToValidate="textPrice" ValidationExpression="^\d(0,8)(\.\d(1,4))?$"></asp:RegularExpressionValidator>
												</div>
											</div>
											<div class="form-group">
												<label>Product Quantity</label>
												<div>
													<asp:TextBox ID="textQuantity" runat="server" CssClass="form-control" placeholder="Enter Product Quantity"></asp:TextBox>
													...
													<asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server" ErrorMessage="Quantity must be none negative" ForeColor="Red" Display="Dynamic" SetFocusOnError="true" ControlToValidate="textQuantity" ValidationExpression="^([1,9]\d+|0)$"></asp:RegularExpressionValidator>
												</div>
											</div>
											<div class="form-group">
											...
											<div class="form-group">
												...
												<div>
													<asp:DropDownList ID="ddlCategories" runat="server" CssClass="form-control" DataTextField="Name" DataValueField="CategoryId" DataSourceID="SqlDataSource1" AppendDataBoundItems="true">
														<asp:ListItem Value="0">Select Category</asp:ListItem>
													</asp:DropDownList>
													<asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ErrorMessage="Description is required" ForeColor="Red" Display="Dynamic" SetFocusOnError="true" ControlToValidate="ddlCategories" InitialValue="0"></asp:RequiredFieldValidator>
								...
								<div class="col-sm-6 col-md-8 col-xl-8 mobile-inputs">
